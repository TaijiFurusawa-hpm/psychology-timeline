...
const PEOPLE: Person[] = [
  ...
  { id:"gallwey",    name:"ガルウェイ",      en:"Gallwey",         year:1974,            school:"humanistic",      influences:["maslow"],            desc:"インナーゲーム（1974年『The Inner Game of Tennis』）。「頭の中の対戦相手こそ最強の敵」——パフォーマンスを阻む内的障壁への気づきを促す手法。指導者が教えるのではなく、学習者自身の自然な学習能力を引き出す。マズローの人間性心理学・自己実現の影響。スポーツからビジネスコーチングへ展開し、ウィットモアのGROWモデルの直接的源泉。" },
